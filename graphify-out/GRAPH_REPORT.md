# Graph Report - keepit  (2026-05-09)

## Corpus Check
- 170 files · ~26,213 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 898 nodes · 1284 edges · 93 communities (54 shown, 39 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 128 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2888c22e`
...
Cohesion: 0.06
Nodes (52): getAllContactPersons(), createContract(), deleteContract(), getAllContracts(), updateContract(), createCustomer(), deleteCustomer(), getAllCustomers() (+44 more)

### Community 1 - "Client Data & API Hooks"
Cohesion: 0.05
Nodes (59): api() HTTP Client, authClient (better-auth), useContractHook, Contract Data Actions, useCustomerHook, Customer Data Actions, createContractAction(), deleteContractAction() (+51 more)
...
Cohesion: 0.05
Nodes (31): ContractListItemProps, ContractList(), ContractModal(), ContractModalProps, contractSchema, emptyContract, Props, OfferModal() (+23 more)
...
Cohesion: 0.1
Nodes (15): FlatRateItem(), FlatRateList(), emptyData, FlatRateModalProps, flatRateSchema, UserListItem(), UserListItemProps, UserList() (+7 more)

### Community 12 - "Offer & Customer Components"
Cohesion: 0.1
Nodes (19): Route, FileRoutesByFullPath, FileRoutesById, FileRoutesByPath, FileRoutesByTo, FileRouteTypes, LoginIndexRoute, MainContractsIndexRoute (+11 more)
...
Cohesion: 0.24
Nodes (6): BasicLinkComponent, BasicLinkProps, CreatedLinkComponent, NavLink(), styles, StyleVariants
...
## Knowledge Gaps
- **279 isolated node(s):** `options`, `swaggerSpec`, `app`, `documentWorker`, `Config` (+274 more)
...
- **Why does `api() HTTP Client` connect `Client Data & API Hooks` to `Client Lib & Config`?**
  _High betweenness centrality (0.199) - this node is a cross-community bridge._
- **Why does `api()` connect `Client Data & API Hooks` to `Offer Pipeline & Tasks`, `Auth Context & Core Components`?**
  _High betweenness centrality (0.170) - this node is a cross-community bridge._
- **Why does `fetch` connect `Offer Pipeline & Tasks` to `Client Data & API Hooks`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Are the 39 inferred relationships involving `api()` (e.g. with `getAllCustomersAction()` and `getCustomerByIdAction()`) actually correct?**
  _`api()` has 39 INFERRED edges - model-reasoned connections that need verification._
