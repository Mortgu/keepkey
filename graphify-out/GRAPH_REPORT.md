...
## Corpus Check
- 205 files · ~34,155 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1184 nodes · 1825 edges · 127 communities (87 shown, 40 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 205 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3fa4386c`
...
Cohesion: 0.05
Nodes (48): createContract(), deleteContract(), getAllContracts(), updateContract(), createContact(), createCustomer(), deleteContactById(), deleteCustomer() (+40 more)

### Community 1 - "Client Data & API Hooks"
Cohesion: 0.06
Nodes (46): getAllTasks(), getTaskById(), prisma, connection, converting(), fetchOfferData(), formatFetchedData(), generating() (+38 more)
...
Cohesion: 0.16
Nodes (16): getNextcloudPathsHandler(), getNextcloudStatus(), getNextcloudStatusHandler(), reserveQuoteIdInNextCloud(), updateNextcloudPathsHandler(), checkNextcloudConnection(), getClient(), getNextCloudClient() (+8 more)
...
Cohesion: 0.13
Nodes (12): OfferProductForm(), ProductItem(), productPricingSchema, ProductList(), emptyData, ProductModalProps, productScheme, useContractHook() (+4 more)

### Community 17 - "Product & Supplier Hooks"
Cohesion: 0.21
Nodes (16): createOffer(), createOfferTask(), deleteOffer(), deleteOfferDocument(), downloadOfferDocument(), getNextQuoteId(), getOfferById(), getOfferRevisions() (+8 more)
...
Cohesion: 0.14
Nodes (11): Config, AppError, errorHandler(), prismaErrorMap, logger, morganMiddleware, app, documentWorker (+3 more)
...
Cohesion: 0.16
Nodes (10): Props, Props, DURATIONS, OfferProductForm(), OfferProductInput, Props, OfferProduct, ProductSectionItem() (+2 more)

### Community 25 - "Offer List UI"
Cohesion: 0.16
Nodes (10): OfferFile(), calculatePrice(), findMatchingTier(), PriceCalculatorProps, Tier, formatDate(), formatDuration(), formatEur() (+2 more)
...
Cohesion: 0.2
Nodes (6): getAllContactPersons(), env, adapter, documentQueue, uploadQueue, router
...
Cohesion: 0.22
Nodes (4): AppException, NextCloudException, NextCloudReservationFailedException, UploadJobData
...
- **Why does `api() HTTP Client` connect `Offer Data Types` to `Checkout Schema`, `Modal Component`, `Flat Rate Schema`, `Template Management`, `Auth Context & Core Components`, `Document Templates & Login`, `Order & Queue Processing`, `Offer Validation Schemas`, `Frontend Config Files`, `Customers Route`?**
  _High betweenness centrality (0.221) - this node is a cross-community bridge._
- **Why does `api()` connect `Order & Queue Processing` to `Client Data & API Hooks`, `Key Naming Utility`, `Offer Pipeline & Tasks`, `Checkout Schema`, `Flat Rate Schema`, `Pricing Schema`, `Modal Component`, `Offer Validation Schemas`, `Offer Data Types`, `Frontend Config Files`, `Customers Route`?**
  _High betweenness centrality (0.209) - this node is a cross-community bridge._
- **Why does `fetch` connect `Client Data & API Hooks` to `Order & Queue Processing`?**
