...
## Corpus Check
- 185 files · ~30,365 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1028 nodes · 1518 edges · 111 communities (74 shown, 37 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 158 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `09f46c1d`
...
Cohesion: 0.05
Nodes (49): getAllContactPersons(), getAllTasks(), getTaskById(), env, adapter, prisma, converting(), fetchOfferData() (+41 more)

### Community 1 - "Client Data & API Hooks"
Cohesion: 0.07
Nodes (37): createContract(), deleteContract(), getAllContracts(), updateContract(), createCustomer(), deleteCustomer(), getAllCustomers(), getCustomerById() (+29 more)

### Community 2 - "Server Routes & Auth"
Cohesion: 0.07
Nodes (33): OfferFile(), createOffer(), createOfferTask(), deleteOffer(), deleteOfferDocument(), downloadOfferDocument(), getOfferById(), getOffers() (+25 more)

### Community 3 - "Offer Pipeline & Tasks"
Cohesion: 0.08
Nodes (30): Config, createContactPersons(), createUser(), deleteAccount(), deleteUser(), getAllUsers(), getSessionUser(), getUserById() (+22 more)
...
Cohesion: 0.08
Nodes (28): Button, ButtonComponentProps, Checkbox, CheckboxComponentProps, Collapsable, CollapsableComponentProps, sort_options, DropdownOption (+20 more)
...
Cohesion: 0.12
Nodes (9): FlatRateItem(), FlatRateList(), emptyData, FlatRateModalProps, flatRateSchema, OfferModal(), useFlatRateHook(), Route (+1 more)

### Community 15 - "Product & Contract Types"
Cohesion: 0.2
Nodes (16): createContractAction(), deleteContractAction(), getContractsAction(), updateContractAction(), addTariffConfigAction(), addTariffCustomerAction(), createTariffAction(), deleteTariffAction() (+8 more)
...
Cohesion: 0.14
Nodes (8): Route, Props, Route, TEMPLATES, TemplateType, main layout route with navigation, Route, root route component
...
Cohesion: 0.4
Nodes (4): OfferProductForm(), useContractHook(), useProductHook(), ProductModalSection()
...
## Knowledge Gaps
- **315 isolated node(s):** `options`, `swaggerSpec`, `app`, `documentWorker`, `Config` (+310 more)
...
- **Why does `api() HTTP Client` connect `Order & Queue Processing` to `Order Types`, `Template Management`, `Auth Context & Core Components`, `Product & Contract Types`, `Document Status Component`, `Filter Tab Bar`, `Contract List UI`, `Supplier Schemas`, `Product Schemas`?**
  _High betweenness centrality (0.249) - this node is a cross-community bridge._
- **Why does `api()` connect `Product & Contract Types` to `Order Types`, `Server Data Access Layer`, `Offer Pipeline & Tasks`, `Template Management`, `Document Status Component`, `Filter Tab Bar`, `Order Schemas`, `Supplier Schemas`, `Product Schemas`?**
  _High betweenness centrality (0.218) - this node is a cross-community bridge._
- **Why does `fetch` connect `Server Data Access Layer` to `Product & Contract Types`?**
