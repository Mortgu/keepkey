# Graph Report - keepit  (2026-05-31)

## Corpus Check
- 208 files · ~33,318 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1209 nodes · 1873 edges · 137 communities (94 shown, 43 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 210 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f0e06324`
...
Cohesion: 0.05
Nodes (59): Config, getNextcloudPathsHandler(), getNextcloudStatus(), getNextcloudStatusHandler(), reserveQuoteIdForOffer(), reserveQuoteIdInNextCloud(), updateNextcloudPathsHandler(), createOffer() (+51 more)
...
Cohesion: 0.27
Nodes (6): getAllContactPersons(), adapter, prisma, router, PriceCalculatorProps, Tier
...
- **Why does `api() HTTP Client` connect `Order & Queue Processing` to `Filter Chip`, `Offer Flat Rate Form`, `Order Types`, `Modal Component`, `Contract & Employee UI`, `Toggle Slider Component`, `Session Guard`, `Login Page`, `Prisma Config Alt`, `Main Layout Component`?**
  _High betweenness centrality (0.231) - this node is a cross-community bridge._
- **Why does `api()` connect `Contract & Employee UI` to `Filter Chip`, `Offer Flat Rate Form`, `Client Data & API Hooks`, `Client Lib & Config`, `Modal Component`, `Session Guard`, `Login Page`, `Supplier Item Component`, `Task Item Component`, `Order & Queue Processing`, `Main Layout Component`?**
  _High betweenness centrality (0.213) - this node is a cross-community bridge._
- **Why does `fetch` connect `Client Data & API Hooks` to `Contract & Employee UI`?**
