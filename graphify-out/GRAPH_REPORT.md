...
## Communities (147 total, 39 thin omitted)

### Community 0 - "Server Data Access Layer"
Cohesion: 0.05
Nodes (47): Config, getNextcloudPathsHandler(), getNextcloudStatus(), getNextcloudStatusHandler(), reserveId(), reserveQuoteIdForOffer(), reserveQuoteIdInNextCloud(), updateNextcloudPathsHandler() (+39 more)

### Community 1 - "Client Data & API Hooks"
Cohesion: 0.08
Nodes (30): createProduct(), deleteProduct(), getProduct(), getProducts(), updateProduct(), createContactPersons(), createUser(), deleteAccount() (+22 more)
...
Cohesion: 0.07
Nodes (42): ContactPersonForm component, CustomerList component, CustomerListItem component, CustomerModal component, DocumentItem component with polling, Invoice Copy Document Template (invoice copy.docx), Invoice Document Template (invoice.docx), LoginFormComponent (+34 more)

### Community 4 - "Client Lib & Config"
Cohesion: 0.07
Nodes (25): ContactListItem(), Props, ContactPersonData, ContactPersonForm(), contactPersonSchema, Props, ContactPersonModal(), ContactPersonModalProps (+17 more)

### Community 5 - "Auth Context & Core Components"
Cohesion: 0.07
Nodes (26): Route, Route, Route, FileRoutesByFullPath, FileRoutesById, FileRoutesByPath, FileRoutesByTo, FileRouteTypes (+18 more)

### Community 6 - "Contract & Employee UI"
Cohesion: 0.08
Nodes (21): Button, styles, ButtonComponentProps, DropdownOption, MultiDropdownProps, badgeStyles, BasicLinkComponent, BasicLinkProps (+13 more)

### Community 7 - "Document Templates & Login"
Cohesion: 0.08
Nodes (19): DocumentItem(), Props, styles, OfferRevisionHistory(), Props, OfferCard(), OfferListItemProps, Task (+11 more)
...
Cohesion: 0.15
Nodes (18): converting(), fetchOfferData(), formatFetchedData(), generating(), OfferFetchData, OfferFormatedData, convert, fetch (+10 more)

### Community 12 - "Offer & Customer Components"
Cohesion: 0.21
Nodes (19): createOffer(), createOfferTask(), deleteOffer(), deleteOfferDocument(), downloadOfferDocument(), enqueueDocumentGenerationJob(), enqueueOfferReservation(), enqueueQuoteReservationJob() (+11 more)

### Community 13 - "Order & Queue Processing"
Cohesion: 0.11
Nodes (11): Props, SupplierListItem(), SupplierList(), supplierSchema, SupplierModal(), SupplierModalProps, supplierSchema, useSupplierHook() (+3 more)
...
Cohesion: 0.16
Nodes (11): BaseRepository, Constructor, NextCloudRepository, repository, WebDavRepository, AddNextCloudRepository(), NextcloudRepository, INextCloudRepository (+3 more)

### Community 16 - "Employee User Management"
Cohesion: 0.14
Nodes (19): api() HTTP Client, authClient (better-auth), useContractHook, Contract Data Actions, useCustomerHook, Customer Data Actions, updateSettingAction(), useFlatRateHook (+11 more)

### Community 17 - "Product & Supplier Hooks"
Cohesion: 0.16
Nodes (16): Button, Collapsable, CollapsableComponentProps, OfferList(), sort_options, DropdownOption, FilterChip, filters/index (+8 more)
...
Cohesion: 0.15
Nodes (17): requireSession middleware, calculatePrice utility, contract-controller, ContractsRoute, flatrate-controller, FlatratesRoute, OfferRoute, PricingController (+9 more)
...
Cohesion: 0.2
Nodes (13): converting(), fetchOrderData(), formatOrderData(), generating(), OrderFetchedData, OrderFormattedData, convert, generate (+5 more)

### Community 22 - "Navigation Components"
Cohesion: 0.17
Nodes (11): PricingModal(), TariffConfigModal(), TariffConfigModalProps, TariffProductsModal(), TariffProductsModalProps, useContractHook(), useProductHook(), useTariffHook() (+3 more)

### Community 23 - "Contract List UI"
Cohesion: 0.22
Nodes (11): createPricing(), deletePricing(), getPrice(), updatePricing(), adapter, prisma, router, calculatePrice() (+3 more)

### Community 24 - "Product Catalog UI"
Cohesion: 0.25
Nodes (8): deleteDocument(), renameDocument(), uploadDocument(), validate(), router, router, router, renameDocumentSchema

### Community 25 - "Offer List UI"
Cohesion: 0.21
Nodes (15): contact-person-controller, ContactPersonsRoute, documentQueue (BullMQ), document-worker, lib/auth, lib/env, lib/nextcloud, lib/permissions (+7 more)
...
Cohesion: 0.23
Nodes (10): getAllTasks(), getTaskById(), OfferPipelineContext, generateOfferDocument(), PipelineContext, Result, runPipeline(), Stage (+2 more)
...
Cohesion: 0.22
Nodes (8): offerTaskHandler(), env, logger, enqueueOfferGeneration(), offerGenerateJob(), offerReservationJob(), offerUploadJob(), runOfferPipeline()
...
Cohesion: 0.18
Nodes (9): ContractListItem(), ContractListItemProps, ContractList(), ContractModal(), ContractModalProps, contractSchema, emptyContract, useModal() (+1 more)

### Community 33 - "Customer Types"
Cohesion: 0.19
Nodes (9): UserListItem(), UserListItemProps, UserList(), createUserSchema, editUserSchema, emptyUser, UserModal(), UserModalProps (+1 more)
...
Cohesion: 0.17
Nodes (11): CreateOfferFlatRatesInput, CreateOfferInput, CreateOfferPositionInput, Offer, OfferFlatRate, OfferPosition, OfferRevision, OfferTask (+3 more)

### Community 36 - "Template Management"
Cohesion: 0.17
Nodes (7): ConfigRow, pricingFormSchema, PricingModalProps, TariffCustomerModal(), TariffCustomerModalProps, OverrideTarget, Route

### Community 37 - "Modal Component"
Cohesion: 0.2
Nodes (7): FlatRateItem(), FlatRateList(), emptyData, FlatRateModalProps, flatRateSchema, OfferModalForm(), useFlatRateHook()

### Community 38 - "Select Component"
Cohesion: 0.23
Nodes (9): DURATIONS, OfferProductForm(), OfferProductInput, Props, OfferProduct, ProductSectionItem(), Props, styles (+1 more)
...
Cohesion: 0.21
Nodes (12): AdminRoute, Auth lib (better-auth), CustomerController, CustomersRoute, documentQueue lib, OfferPipelineContext, Offer pipeline stages, OrderController (+4 more)
...
Cohesion: 0.22
Nodes (9): postprocessing(), deepIterate(), expr, expressionParser, interpolate(), parser, ParserResult, require (+1 more)
...
Cohesion: 0.29
Nodes (10): contactPersonSchema, contract-schemas, customer-schemas, flatrate-schemas, order-schemas, pricing-schemas, product-schemas, schemas/index (+2 more)

### Community 50 - "Single Dropdown"
Cohesion: 0.31
Nodes (7): OrderPipelineContext, orderGenerateJob(), generateOrderDocument(), Result, runOrderPipeline(), orderStages, runPipeline()

### Community 51 - "Search Bar"
Cohesion: 0.28
Nodes (5): getAllContactPersons(), Request, requireSession(), router, router
...
Cohesion: 0.33
Nodes (4): orderTaskHandler(), orderReservationJob(), orderUploadJob(), taskHandler()

### Community 69 - "Pricing Schema"
Cohesion: 0.47
Nodes (5): createOffer(), enqueueDocumentGenerationJob(), enqueueOfferReservation(), enqueueQuoteReservationJob(), taskQueue

### Community 70 - "Flat Rate Schema"
Cohesion: 0.47
Nodes (3): updateSettings(), router, updateSettingSchema
...
### Community 95 - "User Settings Route"
Cohesion: 0.67
...
- **Why does `api() HTTP Client` connect `Employee User Management` to `Document Templates & Login`, `Customer Offer Documents`, `Toggle Slider Component`, `Task Item Component`, `Supplier Item Component`, `Select Types`, `Document Status Component`, `Schemas Index`, `Format Utilities`?**
  _High betweenness centrality (0.245) - this node is a cross-community bridge._
- **Why does `api()` connect `Customer Offer Documents` to `Client Data & API Hooks`, `Task Item Component`, `Supplier Item Component`, `Select Types`, `Customer Management UI`, `Employee User Management`, `Document Status Component`, `Schemas Index`, `Prisma Config Alt`, `Format Utilities`, `Key Name Helper`?**
...
- **Are the 16 inferred relationships involving `useModal()` (e.g. with `CustomerListItem()` and `CustomerList()`) actually correct?**
