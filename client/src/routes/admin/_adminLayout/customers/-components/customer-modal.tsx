...
const customerSchema = z.object({
    customerId: z.string().min(1, "Mindestens 1 Zeichen!"),
...
export default function CustomerModal({ isOpen, onClose, currentCustomer }: CustomerModalProps) {
    ...
    const customerForm = useForm({
        ...
        onSubmit: ({ value }) => {
            const body: Partial<Customer> = { ...value, contactPersons };
            if (isEdit) {
            ...
            <div className="p-4 relative bg-white rounded-lg shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col">
                <form onSubmit={(e) => {
                    ...
                    <div className='flex items-center gap-4'>
                        ...
                        <customerForm.Field name="name" children={(field) => (
                    ...
                    <div className='flex items-center gap-4'>
                        <customerForm.Field name="salutation" children={(field) => (
                            <div className='flex-1 grid gap-2'>
                        ...
                        <customerForm.Field name="firstName" children={(field) => (
                            <div className='flex-1 grid gap-2'>
                        ...
                        <customerForm.Field name="lastName" children={(field) => (
                            <div className='flex-1 grid gap-2'>
