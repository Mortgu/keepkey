...
export default function TariffConfigModal({
    open,
    cancelFn,
    tariffId,
}: TariffConfigModalProps) {
    ...
    return (
        <ModalDialog open={open} cancelFn={cancelFn}>
                    ...
                    <div className="grid grid-cols-4 gap-2">
                        ...
                        <label className="grid gap-1 text-sm">
                            ...
                            <Input
                                ...
                                value={max_quantity ?? ""}
                                onChange={(e) =>
                                    setMax(e.target.value ? parseInt(e.target.value) : null)
                                }
                            />
                        </label>
                        <label className="grid gap-1 text-sm">
            ...
            <ModalDialog.Footer>
                ...
                <Button
                    form="tariff-config-form"
                    type="submit"
                    size="sm"
                    disabled={!contractId || isAddingConfig}
