...
router.post('/', requireSession, canCreateProduct, validate(createProductSchema), createProduct);

/* [DELETE] http://localhost:3000/api/products/{id} */
router.delete('/:id', requireSession, canDeleteProduct, deleteProduct);

/* [PUT] http://localhost:3000/api/products/{id} */
router.put('/:id', requireSession, canUpdateProduct, validate(updateProductSchema), updateProduct)
