...
import { formatDuration, formatEur } from "../../utils/utils.js";
import { deepIterate, customParser } from "./utils.js";
...
export const formatOfferData = async (fetchedData: OfferFetchData) => {
  ...
  const { customer, customerContactPerson, user: employee, language } = offer;
